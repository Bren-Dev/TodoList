...
export const WrapperButtons = styled.div(
  ({ filter }: ContainerProps) =>
    ...
    #all{
        ...
        border: ${
          filter === "all" ? "1px solid #737780" : "1px solid #737780"
        } ;
    }
    #active{
        ...
        border: ${
          filter === "active" ? "1px solid #737780" : "1px solid #737780"
        } ;
    }
    #done{
        ...
        border: ${
          filter === "done" ? "1px solid #737780" : "1px solid #737780"
        } ;
    }
        button:hover{
            color: white;
